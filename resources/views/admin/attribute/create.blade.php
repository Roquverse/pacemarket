                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <select class="form-control select2-hide-search" name="type" id="attrType">                                
                                                        <option value="color"  {{ old('type') == "color" ? 'selected' : ''}}>{{ __('Color') }}</option>                        
                                                    ...
                                                    <tr draggable="false" id="rowid-1">
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <input type="text" name="values[]" class="form-control inputFieldDesign attribute-value" required oninvalid="this.setCustomValidity('{{ __('This field is required.') }}')">
                                                        ...
                                                        <td class="colorCode">
                                                            <div class="form-group">
                                                                <input type="text" 
                                                                    class="form-control demo inputFieldDesign" 
                                                                    data-control="hue" 
                                                                    name="additional_values[]">
                                                            </div>
                                                        </td>
                                                        <td class="text-center">
                                                            <button type="button" id="delete-value" class="btn btn-xs btn-danger delete-row" data-row-id=1 data-bs-toggle="tooltip" data-bs-title="Delete Value">
