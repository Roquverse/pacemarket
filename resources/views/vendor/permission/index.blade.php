                ...
                <div class="col-lg-9 col-12 ps-3 ps-lg-0 rtl:pe-0 pe-0">
                    <div class="card card-info shadow-none mb-0">
                        <div class="card-header p-t-20 border-bottom mb-2">
                            <div class="mt-21p"></div>

                            <div class="card-header-right d-inline-block ltr:ps-3 rtl:pe-3 mt-2">
                                        ...
                                        <table class="table text-center myTable role-permission-table">
                                            <thead class="thead-sticky table-header">
                                                <tr>
                                                    ...
                                                    @php
                                                        $columnWidth = count($roles) >= 1 ? $columnWidth = intval(80 / count($roles)) . '%' : 80 . '%'; 
                                                    @endphp
                                                                                    ...
                                                                                    @foreach ($roles as $role)
                                                                                        <td class="text-center"
                                                                                            ...
                                                                                            @if ($role['slug'] == 'super-admin')
                                                                                                <span><i
                                                                                                        class="fas fa-check p-icon"></i></span>
                                                                                            @else
                                                                                                <span class="prms"
...
@section('js')
    <script src="{{ asset('public/dist/js/custom/vendor-permission.min.js') }}"></script>
@endsection
