                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5" id="formBlock">
                                        ...
                                        @hasPermission('App\Http\Controllers\Vendor\CategoryController@edit')
                                        ...
                                        <div class="d-flex p-0 mt-2">
                                            ...
                                            @hasPermission('App\Http\Controllers\Vendor\CategoryController@destroy')
                                                <a href="javascript:void(0)"
                                                   class="btn custom-btn-cancel delete all-cancel-btn">{{ __('Delete') }}</a>
                                            @endhasPermission

                                            @hasAnyPermission(['App\Http\Controllers\Vendor\CategoryController@store', 'App\Http\Controllers\Vendor\CategoryController@update'])
