                                ...
                                <div class="md:mb-10 mb-6 relative">
                                    ...
                                    <div>
                                        @if (preference('user_login', 'both') == 'both')
                                            <span class="enable-login-phone-section cursor-pointer ltr:float-right rtl:float-left roboto-medium font-medium text-gray-10 hover:text-gray-12 text-11 md:text-sm mt-1">{{ __('Use Phone Instead') }}</span>
                                        @endif
                            ...
                            <div class="md:mb-4 md:mt-4 flex justify-between">
                                <div class="form-check">
                                    <input id="flexCheckDefault"
                                        class="form-check-input md:-mt-0.5 ltr:mr-1 rtl:ml-1 h-3 w-3 md:h-3.5 md:w-3.5 border text-gray-12 border-gray-10 form-checkbox cursor-pointer"
                                ...
                                <div
                                    ...
                                    @if (in_array('Facebook', $preference))
                                        <a href="{{ route('login.facebook') }}"
                                            ...
                                            <span class="ltr:mr-1.5 ltr:md:mr-2.5 rtl:ml-1.5 rtl:md:ml-2.5">
                                                <svg class="h-3 md:h-4" xmlns="http://www.w3.org/2000/svg"
...
<script src="{{ asset('public/dist/js/custom/site/login.min.js?v=2.9.3') }}"></script>
