            ...
            <div class="w-full lg:w-72% ltr:lg:pr-3 rtl:lg:pl-3">
                ...
                <section class="md:mb-10">
                    <div id="tabs" class="c-tabs">
                        ...
                        @endif
                        @if (!empty($vendorDetails))
                            @include('site.layouts.section.product-details.vendor-info')
                        @endif
                        @if ($reviews_allowed == 1 && preference('reviews_enable_product_review') == 1)
                                ...
                                @for ($i = 1; $i <= 3; $i++)
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <p class="skeleton-box py-2 inline-block w-full text-20 text-gray-12 dm-sans mt-0.5 font-medium"></p>
                            ...
                            @for ($i = 0; $i <= 6; $i++)
                                <div class="mt-4 flex">
                                    ...
                                    <div class="text-center ml-10 w-150p mr-10">
                                        <p class="text-13 text-gray-10 roboto-medium mt-3 skeleton-box py-2 inline-block w-full"></p>
                                        <p class="skeleton-box py-2 inline-block w-9/12 text-20 text-gray-12 dm-sans mt-0.5 font-medium w-full"></p>
                                        <div class="item-rating mt-1p skeleton-box py-2 inline-block w-full"></div>
                                    </div>
                                </div>
                            @endfor
